...
def _payload(place_id: str, locale: str) -> dict:
...
def match_places(title: str, video_id: str, locale: str) -> list[dict]:
    ...
    return [_payload(place_id, locale) for place_id in matched_ids[:6]]
